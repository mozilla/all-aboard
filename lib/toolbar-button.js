...
var { notificationsManager, onNotificationEvent } = require('./notification-manager.js');
var { once } = require('./utils.js');

onNotificationEvent('resetState', function() {
...
exports.toolbarButton = {
    ...
    */
    showBadge: function() {
        ...
        module.exports.toolbarButton.addAddOnButton();
    ...
    addAddOnButton: function() {
        ...
        if (typeof this.allAboard === 'undefined') {
