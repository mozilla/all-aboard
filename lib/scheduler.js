...
exports.scheduler = {
    ...
    scheduleNextNotification: function() {
        ...
        module.exports.scheduler.autoCloseTimer(intervals.afterInteractionCloseTime);
        ...
        module.exports.scheduler.startDestroyTimer(intervals.nonuseDestroyTime);
    },
    /**
    ...
    setProgress: function() {
        ...
        if (typeof currentStep === 'undefined'
            || (storageManager.get('ctaComplete') && currentStep !== 'reward')) {
