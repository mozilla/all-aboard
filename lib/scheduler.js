...
exports.scheduler = {
    ...
    */
    destroyAddOn: function() {
        ...
        /*
         * pageMods will not receive the emit sent by utils unless
         * the page(s) they are targetted at are currently loaded
         * in the browser. We therefore need to set an explicit flag
         * here, to indicate that the add-on is detroyed. This can
         * then be used in the various pageMods to ensure they do
         * not execute, should they be invoked again but instead,
         * destroy itself again and do any required cleanup.
         */
        storageManager.set('addOnDestroyed', true);
        // destroys the addon
        utils.destroy();
    },
    /**
    ...
    setProgress: function() {
        ...
        // If this is step one or, the previous step has been completed, move forward.
