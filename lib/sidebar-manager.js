...
exports.sidebarManager = {
    ...
    sidebarKeys: [
        {
            id: 'allaboard-content1',
            title: 'Freedom'
        },
        {
            id: 'allaboard-content2',
            title: 'Privacy'
        },
        {
            id: 'allaboard-content3',
            title: 'Searching'
        },
        {
            id: 'allaboard-content4',
            title: 'Mobile'
        }
    ],
    /**
    ...
    ctaComplete: function(isOnDemand, sidebarProps, worker) {
        if (isOnDemand) {
            ...
            if (!storageManager.get('ctaComplete')) {
                ...
                // call startDestroyTimer here. This will ensure that any current
                // destroyTimer is cleared, and a new timer is started.
                scheduler.startDestroyTimer();
            }
        } else {
            module.exports.sidebarManager.updateAddOnProgress(sidebarProps, worker);
            // call startDestroyTimer here. This will ensure that any current
    ...
    getOnDemandProps: function(sidebarProps) {
        let sidebarIdTitle = module.exports.sidebarManager.sidebarKeys[sidebarProps.step - 1];

        sidebarProps.id = sidebarIdTitle.id;
        sidebarProps.title = sidebarIdTitle.title;
        sidebarProps.onDemandURL = './tmpl/sidebars/content' + sidebarProps.step + '.html';
    ...
    setSidebarProps: function() {
        ...
        if (currentStep === intervals.totalStepCount) {
            sidebarProps = module.exports.sidebarManager.sidebarKeys[3];
        } else {
            sidebarProps = module.exports.sidebarManager.sidebarKeys[currentStep - 1 || 0];
        ...
        // not on step 4 yet. Move forward by one step.
        if (tokens.indexOf(latestToken) > -1
            ...
            && currentStep !== intervals.totalStepCount) {
        ...
        sidebarProps.url = './tmpl/sidebars/content' + contentStep + '.html';
    ...
    */
    toggleSidebar: function() {
        ...
        if (step !== intervals.totalStepCount && typeof tokensArray !== 'undefined'
            && utils.getTimeElapsed(lastCTACompleteTime) >= intervals.defaultSidebarInterval
